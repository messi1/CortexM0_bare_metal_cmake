...
namespace util
{
  ...
  public:
    ...
    static void set_direction_output()
    {
      ...
      *reinterpret_cast<volatile reg_value_type*>(m_dir_reg) |= static_cast<reg_value_type>(1ULL << bit_pos);
    }

    static void set_direction_input()
    {
      // util::reg_access_static<reg_addr_type, reg_value_type, m_dir_reg, bit_pos>::bit_clr();
      *reinterpret_cast<volatile reg_value_type*>(m_dir_reg) &= static_cast<reg_value_type>(~static_cast<reg_value_type>(1ULL << bit_pos));
    }
    ...
    static void set_pin_high()
    {
      ...
      *reinterpret_cast<volatile reg_value_type*>(m_data_reg)  = out_val_high;
    }
    ...
    static void set_pin_low()
    {
      ...
      *reinterpret_cast<volatile reg_value_type*>(m_data_reg)  = out_val_low;
    }

    static bool read_input_value()
    {
      // Read the port input value.
      return static_cast<bool>(((*reinterpret_cast<volatile reg_value_type*>(m_data_reg)) >> bit_pos)& 1);
//        (util::reg_access_static<reg_addr_type, reg_value_type, m_data_reg>::reg_get() >> bit_pos) & 1);
    ...
    static void toggle_pin()
    {
      ...
      *reinterpret_cast<volatile reg_value_type*>(m_data_reg) ^= static_cast<reg_value_type>(1ULL << bit_pos);
    }
