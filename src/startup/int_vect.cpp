...
extern "C" void __wdt_handler        () __attribute__((used, noinline));

extern "C" void __vector_unused_irq  () { for(;;) { asm volatile("nop"); } }
extern "C" void __nmi_handler        () { for(;;) { asm volatile("nop"); } }
extern "C" void __hard_fault_handler () { for(;;) { asm volatile("nop"); } }
extern "C" void __svc_handler        () { for(;;) { asm volatile("nop"); } }
extern "C" void __pend_sv_handler    () { for(;;) { asm volatile("nop"); } }
...
extern "C"
const  ptr_func_t __isr_vectors[] __attribute__((section(".isr_vector"), used)) =
{
